...
# ─── Sidebar ────────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('<div class="hero-title" style="font-size:1.6rem">🧠 Notiv</div>', unsafe_allow_html=True)
...
st.markdown('<div class="hero-tagline">From Voice to Value</div>', unsafe_allow_html=True)
st.markdown('<div class="hero-sub">AI Meeting Intelligence Platform</div>', unsafe_allow_html=True)
st.markdown("---")
        ...
        for msg in st.session_state.chat_history:
            if msg["role"] == "user":
                ...
                <div class="chat-msg" style="align-items:flex-start">
                    <span class="chat-label bot-label">🧠 Notiv</span>
